...
func (d defaultNotice) NoticeCreate(ctx context.Context, req *notice_v1.NoticeCreateReq) (res *notice_v1.NoticeCreateRes, err error) {
	...
	if _, err = dao.Notice.Ctx(ctx).Insert(noticeInfo); err != nil {
